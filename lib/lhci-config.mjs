...
export function createLhciConfigSource(options = {}) {
  const defaults = {
    ...
    fcpMaxMs: normalizeThreshold(options.fcpMaxMs, "1800"),
    ttfbMaxMs: normalizeThreshold(options.ttfbMaxMs, "800"),
...
addMaxNumericValue(assertions, "first-contentful-paint", optionalNumberEnv("LIGHTHOUSE_FCP_MAX_MS", defaults.fcpMaxMs))
addMaxNumericValue(assertions, "server-response-time", optionalNumberEnv("LIGHTHOUSE_TTFB_MAX_MS", defaults.ttfbMaxMs))
